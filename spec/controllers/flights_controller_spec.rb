...
RSpec.describe FlightsController, type: :controller do
  let(:valid_flight) { FactoryGirl.create(:flight) }

  let(:invalid_flight) { FactoryGirl.create(:invalid_flight) }
  ...
  #       expect do
  #         post :create, { flight: valid_flight }, valid_session
  ...
  #   context "with valid params" do
  #     let(:new_attributes) { FactoryGirl.create(:flight) }
  #
  ...
  #     it "assigns the requested flight as @flight" do
  #       flight = valid_flight
  #       put :update, { id: flight.to_param, flight: valid_flight }, valid_session
  #       expect(assigns(:flight)).to eq(flight)
  #     end
  #
  ...
  #       flight = valid_flight
  #       put :update, { id: flight.to_param, flight: invalid_flight }, valid_session
  #       expect(assigns(:flight)).to eq(flight)
  #     end
  #
